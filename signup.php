...
<div class="container"  style=" padding-top:85px">
    ...
    <div class="container"style=" background-color:#222222;> 
     <div class="row" >
	  <div class="col-md-3">
	  <div class="img1"> 
	     <img  src="door.jpg" alt="Pineapple" width="550"  height="500">
	   </div>
	  </div>
        ...
        <div class="col-md-6"> 
           <?php echo $msg; ?>
            <div class="page-header">
                <h1 style="text-align: center; color: #e13737;">Sign Up</h1>      
          </div> 
            <form class="form-horizontal animated bounce" action="" method="post"> 
                ...
                <div class="input-group">
                  <button type="submit" name="submit" class="btn btn-success" style="background-color: #e13737;">Sign Up</button>
