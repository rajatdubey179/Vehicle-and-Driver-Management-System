  ...
  $connection= mysqli_connect('localhost','root','','vehicle management');
   $msg= "" ;     
    ...
    if(isset($_POST['submit'])){
        ...
        $draadharCardNo=$_POST['draadharCardNo'];
       ...
       move_uploaded_file($_FILES['file']['tmp_name'],"picture/".$_FILES['file']['name']); 
        ...
        $res=false;
        $insert_query="INSERT INTO driver(driverid, drname, drjoin, drmobile, draadharCardNo, drlicense, drlicensevalid, draddress, drphoto,dr_available) VALUES (NULL,'$drname','$drjoin','$drmobile','$draadharCardNo','$drlicense','$drlicensevalid','$draddress','$drphoto',1)";        
        ...
        <div class="col-md-6 animated bounceIn"> 
            ...
            <form class="form-horizontal" action="" method="post" enctype="multipart/form-data" >
                ...
                <br>
                 ...
                 <div class="input-group">
                  <span class="input-group-addon"><b>Aadhar Card Number</b></span>
                  <input id="draadharCardNo" type="text" class="form-control" name="draadharCardNo" placeholder="AadharCardNo">
                </div>
                <br> 
