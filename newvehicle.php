  ...
  $connection= mysqli_connect('localhost','root','','vehicle management');
   $msg= "" ;
    ...
    if(isset($_POST['submit'])){
        ...
        $res=false;
        $insert_query="INSERT INTO vehicle(veh_id,veh_reg,veh_type,chesisno,brand,veh_color,veh_regdate,veh_description,veh_photo,veh_available,rates) VALUES (NULL,'$regno','$type','$chesisno','$brand','$color','$regdate','$description','$photo','1','$rates')";
         ...
         <!--
          ...
          <form action="" method="post" enctype="multipart/form-data">
              <div class="input-group">
                  ...
                  <input id="photo" type="file" class="form-control" name="file"> 
            ...
            <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                ...
                <br>
                 ...
                 <script>
                  ...
                  <div class="input-group">
                  <span class="input-group-addon"><b>Rates [/km]</b></span>
                  <input id="rates" type="text" class="form-control" name="rates" placeholder="Rates[/km]">
                </div>
                <br>
                ...
                <br>
                 ...
                 <div class="input-group">
                  <span class="input-group-addon"><b>Description</b></span>
                     <textarea rows="5" id="vehdescription" type="text" class="form-control" name="vehdescription" placeholder="Address"> </textarea>
