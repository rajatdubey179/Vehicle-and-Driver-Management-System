                ...
                <tbody>
                    ...
                    <tr>
                      ...
                      <?php if($row['finished']==1 and $row['paid']==0 ){  ?>
                        <td><a class="btn btn-success" href="bill.php?id=<?php echo $row['booking_id']; ?>">Bill</a></td> 
                       <?php } else if($row['finished']==0 and $row['paid']==0 ){  ?>
                        <td><a class="btn btn-success disabled" href="bill.php?id=<?php echo $row['booking_id']; ?>">Bill</a></td> 
